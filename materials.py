...
class Material:
    ...
    def R(self, I, bandpass):
        return I*spi.quad(self.reflectivity, bandpass[0], bandpass[1])[0]
    
    def T(self, I, bandpass):
        return I*spi.quad(self.transmittivity, bandpass[0], bandpass[1])[0]
    
    def A(self, I, bandpass):
        return I*spi.quad(self.absorption, bandpass[0], bandpass[1])[0]
