if __name__ == '__main__':
    ...
    Data.produce_corner_plot(model_parameters,{'radius':(0.9,1.1), 'disk_gap':(0.01,3.5), 'ring_width':(0.2,1.3)},ringed = True, log = False, planet_sc_law=scattering.Jupiter, ring_sc_law=scattering.Rayleigh)
